...
class Qwen2_5_VLForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        ```"""
        if mos == None:
            raise ValueError("mos value is None!")
        else:
            mos = mos[0]
        ...
        # tokenizer = AutoTokenizer.from_pretrained("/home/wuyuyang/main/output/QA_v8/checkpoint-3200-merged/")
        # tokens = tokenizer.convert_ids_to_tokens(input_ids[0].tolist())
        # print("Last 10 tokens in the sequence:")
        # print(tokens[-10:])


        last_hidden_states = outputs.hidden_states[-1]
        input_tensor = last_hidden_states[:, -3, :]
        print('last_hidden_states shape:', input_tensor.shape)
        print(input_tensor)
        ...
        self.mlp_score.to(device)
        mos = mos.to(device)

        score1 = self.mlp_score(input_tensor)
        print('mos:', mos)
        print('score1:', score1)
        print("WEIGHTS: ", self.mlp_score.fc1.weight)
